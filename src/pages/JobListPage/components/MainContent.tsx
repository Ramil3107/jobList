...
export const MainContent = () => {
    return (
        <div className="flex w-full">
            ...
            <div className="flex flex-col justify-between w-[65%] h-[130px] ml-[26px] border">
                <h1 className="text-[20px] text-[#3A4562] font-bold leading-[25px] mb-[8px]">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maiores ab maxime aspernatur!
                </h1>
